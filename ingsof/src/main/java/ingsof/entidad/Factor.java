...
public class Factor {
    ...
    public String getSalados() { return salados; }
    public void setSalados(String salados) { this.salados = salados; }

    public String getFrutas() { return frutas; }
    public void setFrutas(String frutas) { this.frutas = frutas; }

    public String getFrituras() { return frituras; }
    public void setFrituras(String frituras) { this.frituras = frituras; }

    public String getBebidasCalientes() { return bebidasCalientes; }
    public void setBebidasCalientes(String bebidasCalientes) { this.bebidasCalientes = bebidasCalientes; }

    public String getPesticidas() { return pesticidas; }
    public void setPesticidas(String pesticidas) { this.pesticidas = pesticidas; }

    public String getQuimicos() { return quimicos; }
    public void setQuimicos(String quimicos) { this.quimicos = quimicos; }

    public String getDetalleQuimicos() { return detalleQuimicos; }
    public void setDetalleQuimicos(String detalleQuimicos) { this.detalleQuimicos = detalleQuimicos; }

    public String getHumoLena() { return humoLena; }
    public void setHumoLena(String humoLena) { this.humoLena = humoLena; }

    public String getFuenteAgua() { return fuenteAgua; }
    public void setFuenteAgua(String fuenteAgua) { this.fuenteAgua = fuenteAgua; }

    public String getTratamientoAgua() { return tratamientoAgua; }
    public void setTratamientoAgua(String tratamientoAgua) { this.tratamientoAgua = tratamientoAgua; }
